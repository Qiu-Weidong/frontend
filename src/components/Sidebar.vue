<template>
    <div class="sidebar">
        <el-menu class="sidebar-el-menu" :default-active="onRoutes" :collapse="collapse" background-color="#195FFF"
            text-color="#fff" active-text-color="#000" unique-opened router>
